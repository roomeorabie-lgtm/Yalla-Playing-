...
create table if not exists public.players (
  ...
  submitted_answers jsonb default null,
...
-- 5. Drop existing policies if any to avoid errors on rerun
...
drop policy if exists "Allow public update answers" on public.answers;

-- 6. Public Access Policies (Allow all players to read, insert, update rooms & players)
